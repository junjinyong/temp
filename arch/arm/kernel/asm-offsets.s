	...
	.file	"asm-offsets.c"
@ GNU C11 (Ubuntu 11.4.0-1ubuntu1~22.04) version 11.4.0 (arm-linux-gnueabihf)
@	compiled by GNU C version 11.4.0, GMP version 6.2.1, MPFR version 4.1.0, MPC version 1.2.1, isl version isl-0.24-GMP

@ GGC heuristics: --param ggc-min-expand=100 --param ggc-min-heapsize=131072
@ options passed: -mlittle-endian -mno-fdpic -mabi=aapcs-linux -mfpu=vfp -mtp=cp15 -marm -mfloat-abi=soft -mtls-dialect=gnu -march=armv7-a -O2 -std=gnu11 -p -fno-strict-aliasing -fno-common -fshort-wchar -fno-PIE -fno-dwarf2-cfi-asm -fno-ipa-sra -funwind-tables -fno-delete-null-pointer-checks -fno-allow-store-data-races -fstack-protector-strong -fno-stack-clash-protection -fno-strict-overflow -fstack-check=no -fconserve-stack -fstack-protector-strong
	.text
	.syntax divided
	.syntax unified
	.arm
...
main:
	...
	push	{lr}
	bl	__gnu_mcount_nc
@ arch/arm/kernel/asm-offsets.c:38: {
...
.ascii "->TSK_ACTIVE_MM #1484 offsetof(struct task_struct, active_mm)"	@
@ 0 "" 2
...
.ascii "->TSK_STACK_CANARY #1592 offsetof(struct task_struct, stack_canary)"	@
@ 0 "" 2
...
.ascii "->VMA_VM_FLAGS #24 offsetof(struct vm_area_struct, vm_flags)"	@
@ 0 "" 2
