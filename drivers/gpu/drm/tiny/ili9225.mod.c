...
__used __section("__versions") = {
	...
	{ 0xfc2e2381, "mipi_dbi_spi_cmd_max_speed" },
	{ 0x6f8c7972, "mipi_dbi_spi_transfer" },
	...
	{ 0x9e7125ae, "mipi_dbi_buf_copy" },
	{ 0xe8a034df, "drm_dev_exit" },
	{ 0x8e97a3d0, "_dev_err" },
	{ 0x715543dc, "drm_atomic_helper_damage_merged" },
	{ 0x279d1098, "mipi_dbi_hw_reset" },
...
MODULE_INFO(srcversion, "1B25ADFD9A14D979DDCD24B");
