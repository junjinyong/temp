...
$(deps_drivers/iommu/iommu.o):
#SYMVER iommu_device_register 0x06248fdf
#SYMVER iommu_device_unregister 0xa0e0a0ad
...
#SYMVER iommu_group_add_device 0x415e014d
#SYMVER iommu_group_remove_device 0x6314615c
#SYMVER iommu_group_for_each_dev 0xe67f254a
#SYMVER iommu_group_get 0x042e2d35
#SYMVER iommu_group_ref_get 0x4d6d0bbc
#SYMVER iommu_group_put 0x89485687
#SYMVER iommu_register_device_fault_handler 0xf516d3ec
#SYMVER iommu_unregister_device_fault_handler 0x85c3f56a
#SYMVER iommu_report_device_fault 0x41cfe1b1
#SYMVER iommu_page_response 0xf57a5c5e
#SYMVER iommu_group_id 0x6e7943ec
#SYMVER generic_device_group 0xdb43950d
#SYMVER pci_device_group 0x13fb46a4
#SYMVER fsl_mc_device_group 0x775e1d5d
#SYMVER iommu_present 0xc671e055
#SYMVER device_iommu_capable 0xd619794d
#SYMVER iommu_set_fault_handler 0x0eaf24b0
#SYMVER iommu_domain_alloc 0xd079def9
#SYMVER iommu_domain_free 0x82eed062
#SYMVER iommu_attach_device 0x2b9e9f57
#SYMVER iommu_detach_device 0x90e78d07
#SYMVER iommu_get_domain_for_dev 0xba1c7a15
#SYMVER iommu_attach_group 0x767f3180
#SYMVER iommu_detach_group 0x009ee187
#SYMVER iommu_iova_to_phys 0x6161aca5
#SYMVER iommu_map 0x2b98195a
#SYMVER iommu_map_atomic 0xd977d101
#SYMVER iommu_unmap 0x7c755a8e
#SYMVER iommu_unmap_fast 0x32de46c5
#SYMVER iommu_map_sg 0x6fa27413
#SYMVER report_iommu_fault 0xf54ae69d
#SYMVER iommu_enable_nesting 0x7a875576
#SYMVER iommu_set_pgtable_quirks 0xd6df843a
#SYMVER iommu_put_resv_regions 0xfce6ba81
#SYMVER iommu_alloc_resv_region 0x0c81cdd5
#SYMVER iommu_default_passthrough 0xc3ea5305
#SYMVER iommu_fwspec_init 0xa006e465
#SYMVER iommu_fwspec_free 0x8c53a6b8
#SYMVER iommu_fwspec_add_ids 0xb4cd6c35
#SYMVER iommu_dev_enable_feature 0x84375108
#SYMVER iommu_dev_disable_feature 0x603b5e4d
#SYMVER iommu_sva_bind_device 0x9f597ff1
#SYMVER iommu_sva_unbind_device 0x9a44b66b
#SYMVER iommu_sva_get_pasid 0xeaf3dd84
