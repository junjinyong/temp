...
$(deps_drivers/tty/serial/serial_core.o):
#SYMVER uart_write_wakeup 0xa0a83be8
#SYMVER uart_update_timeout 0x359a78a9
#SYMVER uart_get_baud_rate 0x336860d8
#SYMVER uart_get_divisor 0xc56a6e24
#SYMVER uart_xchar_out 0xabc4cb59
#SYMVER uart_console_write 0xd5f062e6
#SYMVER uart_parse_earlycon 0xc5a5c678
#SYMVER uart_parse_options 0x4f72a987
#SYMVER uart_set_options 0x0b6e970b
#SYMVER uart_suspend_port 0x31075673
#SYMVER uart_resume_port 0x07a2c991
#SYMVER uart_register_driver 0x6e648b8d
#SYMVER uart_unregister_driver 0xf0667868
#SYMVER uart_console_device 0xeaaa605c
#SYMVER uart_add_one_port 0x88f77112
#SYMVER uart_remove_one_port 0x3727bd9b
#SYMVER uart_match_port 0xedc05a73
#SYMVER uart_handle_dcd_change 0xa5a0d6fc
#SYMVER uart_handle_cts_change 0xc67f690b
#SYMVER uart_insert_char 0x53b0b78f
#SYMVER uart_try_toggle_sysrq 0x519cd8fe
#SYMVER uart_get_rs485_mode 0x9d838721
