...
$(deps_fs/locks.o):
#SYMVER locks_alloc_lock 0x0e633c8e
#SYMVER locks_release_private 0x1d55a5e1
#SYMVER locks_owner_has_blockers 0x45a25ee5
#SYMVER locks_free_lock 0x4536f4af
#SYMVER locks_init_lock 0xb8e79a7b
#SYMVER locks_copy_conflock 0xd6fdb81d
#SYMVER locks_copy_lock 0xdd991861
#SYMVER locks_delete_block 0xe4308b0d
#SYMVER posix_test_lock 0xb4e5a212
#SYMVER posix_lock_file 0x0b379664
#SYMVER lease_modify 0x95bea977
#SYMVER __break_lease 0x03b9762e
#SYMVER lease_get_mtime 0x6ce33d9b
#SYMVER generic_setlease 0xbfce1176
#SYMVER lease_register_notifier 0x43aa319e
#SYMVER lease_unregister_notifier 0x985453e1
#SYMVER vfs_setlease 0x593875d0
#SYMVER locks_lock_inode_wait 0xe4939f87
#SYMVER vfs_test_lock 0x6bb786f3
#SYMVER vfs_lock_file 0xdf2605a1
#SYMVER locks_remove_posix 0x409ec913
#SYMVER vfs_cancel_lock 0x9d0dedd6
#SYMVER vfs_inode_has_locks 0x62e5a5e9
