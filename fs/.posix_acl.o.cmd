...
$(deps_fs/posix_acl.o):
#SYMVER get_cached_acl 0x74e98551
#SYMVER get_cached_acl_rcu 0x8957ef02
#SYMVER set_cached_acl 0x1ebdbc10
#SYMVER forget_cached_acl 0xd2721a09
#SYMVER forget_all_cached_acls 0x0b41367f
#SYMVER get_acl 0x62472865
#SYMVER posix_acl_init 0xbf59c419
#SYMVER posix_acl_alloc 0x9b496b21
#SYMVER posix_acl_clone 0xfb60faf5
#SYMVER posix_acl_valid 0x08cd4aea
...
#SYMVER posix_acl_chmod 0xe364fe4f
#SYMVER posix_acl_create 0x96c5bb5f
#SYMVER posix_acl_update_mode 0x620a7645
#SYMVER vfs_set_acl_prepare 0xd3d462ec
#SYMVER posix_acl_from_xattr 0x32e798e1
#SYMVER posix_acl_to_xattr 0xfec8c1ef
#SYMVER set_posix_acl 0x14b08ef3
#SYMVER posix_acl_access_xattr_handler 0x0ed89ebf
#SYMVER posix_acl_default_xattr_handler 0xa1ef1e45
