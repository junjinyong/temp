...
$(deps_net/core/sock.o):
#SYMVER sk_ns_capable 0x1ff7d0f5
#SYMVER sk_capable 0xc91d5c87
#SYMVER sk_net_capable 0xfa85626f
...
#SYMVER sk_set_memalloc 0x18ed74b4
#SYMVER sk_clear_memalloc 0x41a5ab32
#SYMVER __sk_backlog_rcv 0x95b4044a
#SYMVER sk_error_report 0xf09dc05b
#SYMVER sock_get_timeout 0xedd17b31
#SYMVER sock_copy_user_timeval 0x5bdb7603
#SYMVER __sock_queue_rcv_skb 0x118a661d
#SYMVER sock_queue_rcv_skb_reason 0x708d58eb
#SYMVER __sk_receive_skb 0x71961d3a
#SYMVER __sk_dst_check 0x27b2aa88
#SYMVER sk_dst_check 0xf64d63ae
#SYMVER sock_bindtoindex 0xddc7b3cb
#SYMVER sk_mc_loop 0xde610976
#SYMVER sock_set_reuseaddr 0xd257863c
#SYMVER sock_set_reuseport 0x88367bcc
#SYMVER sock_no_linger 0xdc3a639b
#SYMVER sock_set_priority 0xe7e8c023
#SYMVER sock_set_sndtimeo 0x7b5c4f9f
#SYMVER sock_enable_timestamps 0x90698898
#SYMVER sock_set_keepalive 0x9faa4c31
#SYMVER sock_set_rcvbuf 0xc6bd01cf
#SYMVER sock_set_mark 0x0ddfecb9
#SYMVER sockopt_lock_sock 0x5c341807
#SYMVER sockopt_release_sock 0x30bd245f
#SYMVER sockopt_ns_capable 0x6259e703
#SYMVER sockopt_capable 0x2a6a5aac
#SYMVER sock_setsockopt 0x4c82c841
#SYMVER sk_alloc 0xa70b86f4
#SYMVER sk_free 0x6efd18ac
#SYMVER sk_clone_lock 0x28b9b967
#SYMVER sk_free_unlock_clone 0x1302f394
#SYMVER sk_setup_caps 0xf47db2c0
#SYMVER sock_wfree 0xe34dee5c
#SYMVER skb_set_owner_w 0x26584b42
#SYMVER skb_orphan_partial 0x83567e50
#SYMVER sock_rfree 0x0b3aafb4
#SYMVER sock_efree 0x44289bce
#SYMVER sock_pfree 0x64f37a24
#SYMVER sock_i_uid 0x2a0b9e30
#SYMVER __sock_i_ino 0xe39d132b
#SYMVER sock_i_ino 0xe8437c97
#SYMVER sock_wmalloc 0x9217a159
#SYMVER sock_kmalloc 0x1e44e99c
#SYMVER sock_kfree_s 0x953fa338
#SYMVER sock_kzfree_s 0xaee3ac91
#SYMVER sock_alloc_send_pskb 0x2672b6e9
#SYMVER __sock_cmsg_send 0x34063ce1
#SYMVER sock_cmsg_send 0x90be4140
#SYMVER skb_page_frag_refill 0xcfd00b76
#SYMVER sk_page_frag_refill 0xc3258497
#SYMVER __sk_flush_backlog 0x254e7b86
#SYMVER sk_wait_data 0x87ea219f
#SYMVER __sk_mem_schedule 0x14c761fc
#SYMVER __sk_mem_reclaim 0x461e4392
#SYMVER sk_set_peek_off 0xed971103
#SYMVER sock_no_bind 0xa9a8aca9
#SYMVER sock_no_connect 0x27af3415
#SYMVER sock_no_socketpair 0x99fa3603
#SYMVER sock_no_accept 0x33c0a21c
#SYMVER sock_no_getname 0xd464dd01
#SYMVER sock_no_ioctl 0xae9e1c26
#SYMVER sock_no_listen 0xe3b08e90
#SYMVER sock_no_shutdown 0x081cf96c
#SYMVER sock_no_sendmsg 0xf0886af7
#SYMVER sock_no_sendmsg_locked 0x926f5e40
#SYMVER sock_no_recvmsg 0x14766d50
#SYMVER sock_no_mmap 0x30c48a4f
#SYMVER sock_no_sendpage 0x0345098b
#SYMVER sock_no_sendpage_locked 0x637d1f96
#SYMVER sk_send_sigurg 0x2680fd60
#SYMVER sk_reset_timer 0x247ddfdd
#SYMVER sk_stop_timer 0x19fc10e0
#SYMVER sk_stop_timer_sync 0x44ae154e
#SYMVER sock_init_data_uid 0x5df91d9d
#SYMVER sock_init_data 0x0ae1c50e
#SYMVER lock_sock_nested 0x3615d0e9
#SYMVER release_sock 0x6b2baf52
#SYMVER __lock_sock_fast 0x3d342b8c
#SYMVER sock_gettstamp 0x15b1bafa
#SYMVER sock_recv_errqueue 0x22a09382
#SYMVER sock_common_getsockopt 0xf92ec2f7
#SYMVER sock_common_recvmsg 0xcaa0e50d
#SYMVER sock_common_setsockopt 0x28d88bcc
#SYMVER sk_common_release 0xc5c94160
#SYMVER sock_prot_inuse_get 0x7e1718de
#SYMVER sock_inuse_get 0x17914f05
#SYMVER proto_register 0xee12e59a
#SYMVER proto_unregister 0x150b5953
#SYMVER sock_load_diag_module 0xf665f74f
#SYMVER sk_busy_loop_end 0xe590dea3
#SYMVER sock_bind_add 0x30fb6f46
