...
SYMBOL_CRC(arpt_alloc_initial_table, 0x95b4cf76, "_gpl");
SYMBOL_CRC(arpt_unregister_table_pre_exit, 0xa900a1d3, "");
SYMBOL_CRC(arpt_register_table, 0xc3a3b3e5, "");
SYMBOL_CRC(arpt_unregister_table, 0xbca34eb3, "");
SYMBOL_CRC(arpt_do_table, 0xea15ac39, "");
...
MODULE_INFO(srcversion, "F610ED97E63F0BC2C2A8C8C");
