...
SYMBOL_CRC(nft_fib4_eval_type, 0x3c19397c, "_gpl");
SYMBOL_CRC(nft_fib4_eval, 0xfcd627e0, "_gpl");
...
__used __section("__versions") = {
	...
	{ 0xc4f6f6f0, "fib_table_lookup" },
	{ 0x2469810f, "__rcu_read_unlock" },
	{ 0x7597ed38, "fib_info_nh_uses_dev" },
	{ 0x76b4c315, "l3mdev_master_ifindex_rcu" },
	{ 0x6c0f83e4, "__fib_lookup" },
