...
SYMBOL_CRC(ip6t_alloc_initial_table, 0xf7051245, "_gpl");
SYMBOL_CRC(ip6t_register_table, 0xf62c82a0, "");
SYMBOL_CRC(ip6t_unregister_table_pre_exit, 0xf27da234, "");
SYMBOL_CRC(ip6t_unregister_table_exit, 0x6bb78cef, "");
SYMBOL_CRC(ip6t_do_table, 0xa4a5156f, "");
...
MODULE_INFO(srcversion, "B449B37CA5381DBA6BC763F");
