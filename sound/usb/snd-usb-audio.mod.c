...
__used __section("__versions") = {
	...
	{ 0xad713c93, "usb_pipe_type_check" },
	...
	{ 0xb471a684, "snd_ctl_rename" },
	{ 0xd35cce70, "_raw_spin_unlock_irqrestore" },
	{ 0x84f7da61, "media_remove_intf_link" },
	{ 0x5a7bab55, "usb_string" },
	{ 0x21f8804, "snd_device_new" },
	{ 0xb107baf9, "snd_pcm_period_elapsed_under_stream_lock" },
	...
	{ 0x3c3ff9fd, "sprintf" },
	{ 0xdd64e639, "strscpy" },
	{ 0xff02c6fc, "usb_disable_autosuspend" },
...
MODULE_INFO(srcversion, "A7E2DB92C59134851198FA7");
